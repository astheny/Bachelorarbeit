...
\begin{enumerate}
  \item[\rm{(K1)}] Jeder Graphen $K\in \mathcal{K}$ sind vollst"andige Graphen mit $|K| \geq 2$.
  \item[\rm{(K2)}] Je zwei verschiedenen Graphen $K,K'$ Graphen aus $\mathcal{K}$ sind kantendisjunkt (d.h. $|K\cap K'| \leq 1$).

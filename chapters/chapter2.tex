...
\begin{proof}
  ...
  \ncase{1} {$r=1$} Dann ist $K_{v:1}$ isomorph zu $K_v$. Dessen Eigenwerte sind alle gr"o{\ss}er als $-2$.
  ...
  \ncase{4}{$2r > v$} Dann ist $|E(G)| = 0$ und folglich ist $G$ ein leerer Graph, welcher nur den Eigenwert $0$ besitzt.
\end{proof}

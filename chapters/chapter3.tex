...
\begin{proof}
  ...
  Eine \DF{dominierende Menge} in $G$ ist eine Menge von Ecken $X$ von $G$ derart, dass jede Ecke in $V(G)\setminus X$ einen Nachbarn in $X$ besitzt. Die kleinste Zahl $k=\gamma(G)$ f"ur die eine dominierende Menge von $k$ Ecken von $G$ existiert, ist die \DF{Dominierungszahl} von $G$. 
